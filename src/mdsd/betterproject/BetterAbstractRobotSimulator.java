...
public abstract class BetterAbstractRobotSimulator {
    private BetterRobotAgent agent;

    public BetterAbstractRobotSimulator(Point position, String name) {
        if (name == null) {
    ...
    protected void setController(BetterAbstractSimulatorMonitor<? extends BetterAbstractRobotSimulator> controller) {
        if (controller == null) {
